...
void AMultiplayerCoOpCharacter::NotifyControllerChanged()
{
...
void AMultiplayerCoOpCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMultiplayerCoOpCharacter::Move);
...
void AMultiplayerCoOpCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMultiplayerCoOpCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
